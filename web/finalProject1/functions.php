            ...
            <?php  
                ...
                for($cb=1;$cb<=$boxDisplay;$cb++){ 
                    if(($cb >= $currentMonthFirstDay+1 || $currentMonthFirstDay == 7) && $cb <= ($totalDaysOfMonthDisplay)){ 
                        ...
                        $result = $db->query("SELECT hw_name FROM hw WHERE due_date = '".$currentDate."'"); 
                        ...
                        echo ($eventNum > 0)?'<a href="javascript:;" onclick="getEvents(\''.$currentDate.'\');">View All Events</a>':''; 
                        echo '</div></div>'; 
...
function getEvents($date = ''){ 
    ...
    $result = $db->query("SELECT hw_name FROM hw WHERE due_date = '".$date."'"); 
