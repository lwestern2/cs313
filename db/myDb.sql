...
CREATE TABLE hw (
	hw_id		int NOT NULL PRIMARY KEY,
    data        Date NOT NULL,
...
CREATE TABLE calendar (
	...
	hw_id		int NOT NULL REFERENCES hw(hw_id),
	list_id		int NOT NULL REFERENCES to_do(list_id),
	user_id		int NOT NULL REFERENCES hw_user(user_id)
);
